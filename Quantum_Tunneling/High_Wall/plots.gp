...
set title "High Wall" font "Menlo,20"
stats "tunneling_high.txt"
f(x) = x >= 0.2 && x <= 0.21 ? 55 : 0 
do for[i=0:STATS_blocks]{set terminal jpeg
set output sprintf("Plots/plots%06.0f.jpeg",i)
plot "tunneling_high.txt" index i using 1:4 ti "Wavefunction" with linespoints pt 0 lw 1 lc rgb "black",\
